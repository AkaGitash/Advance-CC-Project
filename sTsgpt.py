...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"C:\Users\AKASH YADAV\Desktop\Codes\Google-Cloud-Speech-to-Text-API(Credentials)\stsgpt-e490d3d153c6.json"
...
def main():
    ...
    while True:
        ...
        print("Welcome to LuminaCX, say 'HELLO' to proceed")
        speak_text("Welcome to LuminaCX, say 'HELLO' to proceed")
